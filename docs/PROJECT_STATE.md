...
validation PASS; D20 has scoped device validation PASS; D21 has scoped device validation PASS; D22 has scoped device validation PASS; D23 has scoped device validation PASS; D24 has scoped device validation with platform observation (URI_ACCESS_DENIED for empty sources); D25-D26 remain pending.**
