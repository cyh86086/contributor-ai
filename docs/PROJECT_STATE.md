...
validation PASS; D20 has scoped device validation PASS; D21 has scoped device validation PASS; D22 has scoped device validation PASS; D23 has scoped device validation PASS; D24-D26 remain pending.**
...
- D24-D26 still require scoped review, preparation, and in several cases
