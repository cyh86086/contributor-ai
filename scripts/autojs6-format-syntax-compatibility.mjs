...
export function assertAutoJs6FormatSyntaxCompatible(source, label) {
  const findings = findAutoJs6FormatSyntaxIncompatibilities(source);
  if (findings.length > 0) {
    throw new Error(
      `${label ?? "AutoJs6 format-check bundle"} contains incompatible syntax: ${findings
...
export function findAutoJs6FormatSyntaxIncompatibilities(source) {
