...
function main() {
  ...
  try {
    ...
    log(`[ERROR] Test 1 failed: ${testErr.message}`);
  }
  ...
  try {
    ...
    log(`[ERROR] Test 2 failed: ${testErr2.message}`);
  }
  ...
  try {
    ...
    log(`[ERROR] Test 3 failed: ${testErr3.message}`);
  }
  ...
  try {
    ...
    log(`[ERROR] Test 4 failed: ${testErr4.message}`);
  }
  ...
  try {
    ...
    log(`[ERROR] Test 5 failed: ${testErr5.message}`);
  }
