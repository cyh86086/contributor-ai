"ui";
/* GENERATED: non-production AutoJs6 D24_EMPTY_IMAGE device-verification support only. */
...
(function () {
  ...
  var D21_UI_RESPONSIVENESS_CHECK_CASE = defineCase({
    ...
    sourceEntryPath:
      "autojs6/source/d21-ui-responsiveness-device-check.entry.js",
  ...
  var D23_SENSITIVE_LOGGING_CHECK_CASE = defineCase({
    ...
    sourceEntryPath:
      "autojs6/source/d23-sensitive-logging-device-check.entry.js",
  ...
  var FORMAT_CHECK_CASES = Object.freeze([
  ...
  var D02_D05_FORMAT_CHECK_CASES = Object.freeze([
    D02_FORMAT_CHECK_CASE,
    D03_FORMAT_CHECK_CASE,
    D04_FORMAT_CHECK_CASE,
    D05_FORMAT_CHECK_CASE,
  ...
  var ClassifiedImageReaderError = (function (_Error2) {
    ...
    function ClassifiedImageReaderError(classification) {
      ...
      _this2 = _callSuper(this, ClassifiedImageReaderError, [
        "Classified image reader failure.",
      ]);
  ...
  function prepareImageInput(_0) {
    return __async(this, arguments, function (_ref) {
      var sourceUri = _ref.sourceUri,
        ...
        encodeBase64 =
          _ref$encodeBase === void 0 ? encodeBytesToBase64 : _ref$encodeBase;
            ...
            switch (_context.n) {
              ...
              case 5:
                ...
                bytes = normalizeBytes(
                  readResult == null ? void 0 : readResult.bytes,
                );
              ...
              case 7:
                reportedMimeType = normalizeMimeType(
                  readResult == null ? void 0 : readResult.mimeType,
                );
                mimeType = SUPPORTED_MIME_TYPES.has(reportedMimeType)
                  ? reportedMimeType
  ...
  function checkRuntimeAccess(reader, sourceUri) {
    return __async(
      this,
      null,
      _regenerator().m(function _callee3() {
        var _t4, _t5;
        return _regenerator().w(
          function (_context3) {
            while (1)
  ...
  function readImage(reader, sourceUri) {
    return __async(
      this,
      null,
      _regenerator().m(function _callee4() {
        var code, _t6;
        return _regenerator().w(
          function (_context4) {
            while (1)
              switch ((_context4.p = _context4.n)) {
                ...
                case 2:
                  ...
                  _t6 = _context4.v;
                  code =
                    _t6 instanceof ClassifiedImageReaderError &&
                    _t6.classification ===
  ...
  function createAutoJs6AndroidImageReader(_ref2) {
    var context = _ref2.context,
      ...
      chunkSizeBytes =
        _ref2$chunkSizeBytes === void 0
          ? DEFAULT_CHUNK_SIZE_BYTES
          : _ref2$chunkSizeBytes,
      _ref2$maxZeroLengthRe = _ref2.maxZeroLengthReads,
      maxZeroLengthReads =
        _ref2$maxZeroLengthRe === void 0
          ? DEFAULT_MAX_ZERO_LENGTH_READS
          : _ref2$maxZeroLengthRe,
                  ...
                  switch ((_context6.p = _context6.n)) {
                    ...
                    case 2:
                      ...
                      readResult = readCompleteStream({
                        ...
                        toUint8Array:
                          (_a2 = javaBridge.toUint8Array) != null
                            ? _a2
                    ...
                    case 3:
                      ...
                      throw _t8;
                    case 4:
                      throw classifyReaderFailure(
                        _t8,
                        javaBridge.classifyError,
                      );
                    case 5:
                      _context6.p = 5;
                      closeQuietly(stream, safeLogger);
  ...
  function validateDependencies(_ref3) {
    ...
    if (
      ...
      throw new TypeError(
        "A ContentResolver-compatible dependency is required",
      );
    }
  ...
  function evaluateFilePolicy(isFileUriApproved, sourceUri) {
    return __async(
      this,
      null,
      _regenerator().m(function _callee8() {
        var _t10, _t11;
        return _regenerator().w(
          function (_context8) {
            while (1)
  ...
  function runCleanupAfterFailureDeviceCheck(_0) {
    return __async(this, arguments, function (_ref7) {
      var testCaseId = _ref7.testCaseId,
        ...
        reportMetadata =
          _ref7$reportMetadata === void 0
            ? function () {}
            : _ref7$reportMetadata;
            ...
            while (1)
              switch ((_context9.p = _context9.n)) {
                case 0:
                  ...
                  closeCount = 0;
                  instrumentedResolver = createInstrumentedResolver(
                    contentResolver,
                    function () {
                      closeCount += 1;
                    },
  ...
  function runEmptyImageDeviceCheck(_0) {
    return __async(this, arguments, function (_ref1) {
      var _ref1$expectedErrorCo = _ref1.expectedErrorCode,
        expectedErrorCode =
          _ref1$expectedErrorCo === void 0
            ? "EMPTY_IMAGE"
            : _ref1$expectedErrorCo,
        _ref1$reportMetadata = _ref1.reportMetadata,
        reportMetadata =
          _ref1$reportMetadata === void 0
            ? function () {}
            : _ref1$reportMetadata,
            ...
            while (1)
              switch ((_context0.p = _context0.n)) {
                case 0:
                  ...
                  throw new TypeError(
                    "prepareSelectedImage must be a function",
                  );
                case 1:
                  _context0.p = 1;
                  _context0.n = 2;
  ...
  function runImageReaderDeviceCheck(_0) {
    return __async(this, arguments, function (_ref10) {
      var testCaseId = _ref10.testCaseId,
        ...
        reportMetadata =
          _ref10$reportMetadata === void 0
            ? function () {}
            : _ref10$reportMetadata;
              ...
              switch ((_context1.p = _context1.n)) {
                ...
                case 3:
                  ...
                  record = Object.freeze({
                    testCaseId: testCaseId,
                    status: "FAIL",
                    errorCode: PUBLIC_ERROR_CODES2.has(
                      _t14 == null ? void 0 : _t14.code,
                    )
                      ? _t14.code
                      : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED,
                  });
  ...
  function runExactPortableLimitDeviceCheck(_a) {
    return __async(
      this,
      null,
      _regenerator().m(function _callee10() {
        var _b,
          expectedSizeBytes,
          maxSizeBytes,
          readerSafetyLimitBytes,
        ...
        return _regenerator().w(function (_context10) {
          while (1)
            switch (_context10.n) {
              case 0:
                ((_b = _a),
                  (expectedSizeBytes = _b.expectedSizeBytes),
                  (maxSizeBytes = _b.maxSizeBytes),
                  (readerSafetyLimitBytes = _b.readerSafetyLimitBytes),
                  (_b$reportMetadata = _b.reportMetadata),
                  (reportMetadata =
                    _b$reportMetadata === void 0
                      ? function () {}
                      : _b$reportMetadata),
                  (readerOptions = __objRest(_b, [
                    "expectedSizeBytes",
                    "maxSizeBytes",
                    "readerSafetyLimitBytes",
                    "reportMetadata",
                ...
                return runImageReaderDeviceCheck(
                  __spreadProps(__spreadValues({}, readerOptions), {
                    maxSizeBytes: maxSizeBytes,
                    readerSafetyLimitBytes: readerSafetyLimitBytes,
  ...
  function normalizeRecord(_ref12) {
    ...
    return Object.freeze({
      ...
      status: "FAIL",
      errorCode:
        status === "FAIL" && PUBLIC_ERROR_CODES3.has(errorCode)
          ? errorCode
          : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED,
    });
  }
  ...
  function normalizeFormatCheckErrorCode(value) {
    ...
    return PUBLIC_ERROR_CODES4.has(errorCode)
      ? errorCode
      : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED;
  }
            ...
            while (1)
              switch ((_context11.p = _context11.n)) {
                case 0:
                  ...
                  ((showInstructions = dependencies.showInstructions),
                    (pickSingleImage2 = dependencies.pickSingleImage),
                    (executeOffUiThread2 = dependencies.executeOffUiThread),
                    (prepareSelectedImage2 = dependencies.prepareSelectedImage),
                    (reportMetadata = dependencies.reportMetadata));
                  _context11.p = 1;
                  _context11.n = 2;
                ...
                case 9:
                  ...
                  record = failure(
                    formatCase.testCaseId,
                    normalizeFormatCheckErrorCode(_t15),
                    false,
                  );
                case 10:
                  reportMetadata(record);
  ...
  function normalizeStreamCleanupSuccessExecution(formatCase, execution) {
    ...
    if (uiResponsive !== true) {
      return Object.freeze({
        ...
        closeCount:
          (_a = safelyReadProperty4(result, "closeCount")) != null ? _a : 0,
        uiResponsive: false,
      });
    }
    var status = safelyReadProperty4(result, "status");
    ...
    return failure(
      formatCase.testCaseId,
      status === "FAIL" && PUBLIC_ERROR_CODES4.has(errorCode)
        ? errorCode
        : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED,
      true,
    );
  ...
  function normalizeCleanupAfterFailureExecution(formatCase, execution) {
    ...
    if (
      status === "FAIL" &&
      PUBLIC_ERROR_CODES4.has(errorCode) &&
  ...
  function normalizeRepeatedReadsExecution(formatCase, execution) {
    var uiResponsive = safelyReadProperty4(execution, "uiResponsive");
    var result = safelyReadProperty4(execution, "value");
    var requestedIterations = safelyReadProperty4(
      result,
      "requestedIterations",
    );
    var attemptedIterations = safelyReadProperty4(
      result,
      "attemptedIterations",
    );
    var successfulIterations = safelyReadProperty4(
      result,
  ...
  function normalizeMemoryBehaviorExecution(formatCase, execution) {
    ...
    var memoryAfterStabilization = safelyReadProperty4(
      result,
  ...
  function normalizeNoPersistenceExecution(formatCase, execution) {
    ...
    return failure(
      formatCase.testCaseId,
      status === "FAIL" && PUBLIC_ERROR_CODES4.has(failureReason)
        ? failureReason
        : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED,
      true,
    );
  ...
  function failure(testCaseId, errorCode, uiResponsive) {
    return Object.freeze({
      testCaseId: testCaseId,
      status: "FAIL",
      errorCode: PUBLIC_ERROR_CODES4.has(errorCode)
        ? errorCode
        : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED,
  ...
  function validateFormatCase(formatCase) {
    if (
      ...
      !SAFE_CASE_ID3.test(formatCase.testCaseId) ||
      typeof formatCase.pickerMimeType !== "string" ||
      !SAFE_MIME_TYPE2.test(formatCase.pickerMimeType) ||
      typeof formatCase.expectedMimeType !== "string" ||
      !SAFE_MIME_TYPE2.test(formatCase.expectedMimeType) ||
  ...
  function validateDependencies2(dependencies) {
    ...
    for (var _i = 0, _required = required; _i < _required.length; _i++) {
      ...
      if (
        typeof (dependencies == null ? void 0 : dependencies[name]) !==
        "function"
      ) {
    ...
    return __async(
      ...
      _regenerator().m(function _callee12() {
        var _b,
          ...
          result,
          currentMemory,
          matchesRequiredMetadata,
          matchesFirstIteration,
          memoryAfterStabilization,
          memoryGrowth,
          allMetadataEqual,
          record;
          ...
          while (1)
            switch (_context12.n) {
              case 0:
                ((_b = _a),
                  (expectedSizeBytes = _b.expectedSizeBytes),
                  (_b$reportMetadata2 = _b.reportMetadata),
                  (reportMetadata =
                    _b$reportMetadata2 === void 0
                      ? function () {}
                      : _b$reportMetadata2),
                  (readerOptions = __objRest(_b, [
                    "expectedSizeBytes",
  ...
  function normalizePublicErrorCode(errorCode) {
    return PUBLIC_ERROR_CODES5.has(errorCode)
      ? errorCode
      : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED;
  }
  ...
  function runMimeFallbackDeviceCheck(_0) {
    return __async(this, arguments, function (_ref16) {
      var testCaseId = _ref16.testCaseId,
        ...
        reportMetadata =
          _ref16$reportMetadata === void 0
            ? function () {}
            : _ref16$reportMetadata;
              ...
              switch ((_context14.p = _context14.n)) {
                ...
                case 3:
                  ...
                  record = Object.freeze({
                    testCaseId: testCaseId,
                    status: "FAIL",
                    errorCode: PUBLIC_ERROR_CODES6.has(
                      _t16 == null ? void 0 : _t16.code,
                    )
                      ? _t16.code
                      : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED,
                  });
        ...
        return _regenerator().w(function (_context15) {
          while (1)
            switch (_context15.n) {
              case 0:
                ((_b = _a),
                  (sourceUris = _b.sourceUris),
                  (expectedImages = _b.expectedImages),
                  (_b$reportMetadata3 = _b.reportMetadata),
                  (reportMetadata =
                    _b$reportMetadata3 === void 0
                      ? function () {}
                      : _b$reportMetadata3),
                  (readerOptions = __objRest(_b, [
                    "sourceUris",
  ...
  var CONTENT_URI_PATTERN =
    /content:\/\/(?:[\0-\x08\x0E-\x1F!#-&\(-\|~-\x9F\xA1-\u167F\u1681-\u1FFF\u200B-\u2027\u202A-\u202E\u2030-\u205E\u2060-\u2FFF\u3001-\uD7FF\uE000-\uFEFE\uFF00-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])+/;
  var BYTE_ARRAY_PATTERN =
    /\[[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*(?:[0-9]+[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*,[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*){5,}[0-9]+[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*\]/;
            ...
            while (1)
              switch ((_context16.p = _context16.n)) {
                case 0:
                  ...
                  throw new TypeError(
                    "expectedSizeBytes must be a positive safe integer",
                  );
                case 1:
                  if (!(typeof prepareSelectedImage2 !== "function")) {
                    _context16.n = 2;
                ...
                case 4:
                  ...
                  successOutputClean =
                    inspectOutputForPersistence(successRecord);
                  successStatus = safelyReadProperty5(successRecord, "status");
                  successMimeType = safelyReadProperty5(
                    successRecord,
                    "mimeType",
                  );
                  successSizeBytes = safelyReadProperty5(
                    successRecord,
                    "sizeBytes",
                  );
                  _context16.n = 6;
                ...
                case 6:
                  if (
                    ...
                    ((_b =
                      (_a = java == null ? void 0 : java.lang) == null
                        ? void 0
                        : _a.System) == null
                      ? void 0
                      : _b.gc)
                ...
                case 8:
                  ...
                  failureOutputClean =
                    inspectOutputForPersistence(failureRecord);
                  _context16.n = 10;
                  break;
                case 9:
                  _context16.p = 9;
  ...
  function runPortableSizeOverflowDeviceCheck(_a) {
    return __async(
      this,
      null,
      _regenerator().m(function _callee17() {
        var _b,
          expectedSizeBytes,
          maxSizeBytes,
          readerSafetyLimitBytes,
            ...
            switch (_context17.n) {
              case 0:
                ((_b = _a),
                  ...
                  (maxSizeBytes = _b.maxSizeBytes),
                  (readerSafetyLimitBytes = _b.readerSafetyLimitBytes),
                  (_b$reportMetadata4 = _b.reportMetadata),
                  (reportMetadata =
                    _b$reportMetadata4 === void 0
                      ? function () {}
                      : _b$reportMetadata4),
                  (readerOptions = __objRest(_b, [
                    "expectedSizeBytes",
  ...
  function normalizeRecord2(_ref21) {
    ...
    return Object.freeze({
      ...
      status: "FAIL",
      errorCode:
        status === "FAIL" && PUBLIC_ERROR_CODES8.has(errorCode)
          ? errorCode
          : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED,
    });
  }
  ...
  function validateLimits2(_ref22) {
    ...
    if (
      ...
      throw new TypeError(
        "D14 expectedSizeBytes must be a positive safe integer greater than maxSizeBytes",
      );
    }
    if (
      !Number.isSafeInteger(readerSafetyLimitBytes) ||
      ...
      throw new TypeError(
        "D14 readerSafetyLimitBytes must be greater than expectedSizeBytes",
      );
    }
    if (typeof reportMetadata !== "function") {
      throw new TypeError("reportMetadata must be a function");
            ...
            switch (_context18.n) {
              case 0:
                ((_b = _a),
                  ...
                  (maxSizeBytes = _b.maxSizeBytes),
                  (readerSafetyLimitBytes = _b.readerSafetyLimitBytes),
                  (_b$reportMetadata5 = _b.reportMetadata),
                  (reportMetadata =
                    _b$reportMetadata5 === void 0
                      ? function () {}
                      : _b$reportMetadata5),
                  (readerOptions = __objRest(_b, [
                    "expectedSizeBytes",
          ...
          while (1)
            switch (_context19.n) {
              case 0:
                ((_b = _a),
                  (expectedSizeBytes = _b.expectedSizeBytes),
                  (_b$reportMetadata6 = _b.reportMetadata),
                  (reportMetadata =
                    _b$reportMetadata6 === void 0
                      ? function () {}
                      : _b$reportMetadata6),
                  (readerOptions = __objRest(_b, [
                    "expectedSizeBytes",
              ...
              case 3:
                matchesRequiredMetadata =
                  result.status === "PASS" &&
                  result.mimeType === REQUIRED_MIME_TYPE2 &&
                  result.sizeBytes === expectedSizeBytes;
                matchesFirstIteration =
                  iteration === 1 ||
                  (result.mimeType === firstMimeType &&
              ...
              case 6:
                allMetadataEqual =
                  successfulIterations === REQUESTED_ITERATIONS2 &&
                  publicErrorCode === void 0 &&
                  metadataMismatch === false;
  ...
  function normalizePublicErrorCode3(errorCode) {
    return PUBLIC_ERROR_CODES9.has(errorCode)
      ? errorCode
      : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED;
  }
  ...
  function runResolverMimeDeviceCheck(_0) {
    return __async(this, arguments, function (_ref26) {
      var testCaseId = _ref26.testCaseId,
        ...
        reportMetadata =
          _ref26$reportMetadata === void 0
            ? function () {}
            : _ref26$reportMetadata;
  ...
  function failure2(testCaseId, errorCode) {
    return Object.freeze({
      testCaseId: testCaseId,
      status: "FAIL",
      errorCode: PUBLIC_ERROR_CODES10.has(errorCode)
        ? errorCode
        : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED,
    });
  }
  ...
  function validateInputs5(_ref28) {
    ...
    if (
      typeof expectedMimeType !== "string" ||
      !SAFE_MIME_TYPE3.test(expectedMimeType) ||
  ...
  var FILE_PATH_PATTERN =
    /\/(?:sdcard|storage\/emulated\/0)\/(?:[\0-\x08\x0E-\x1F!#-&\(-\|~-\x9F\xA1-\u167F\u1681-\u1FFF\u200B-\u2027\u202A-\u202E\u2030-\u205E\u2060-\u2FFF\u3001-\uD7FF\uE000-\uFEFE\uFF00-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])+/;
  var CONTENT_URI_PATTERN2 =
    /content:\/\/(?:[\0-\x08\x0E-\x1F!#-&\(-\|~-\x9F\xA1-\u167F\u1681-\u1FFF\u200B-\u2027\u202A-\u202E\u2030-\u205E\u2060-\u2FFF\u3001-\uD7FF\uE000-\uFEFE\uFF00-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])+/;
  var BASE64_PATTERN2 = /[\+\/-9A-Za-z]{20,}={0,2}/;
  var BYTE_ARRAY_PATTERN2 =
    /\[[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*(?:[0-9]+[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*,[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*){5,}[0-9]+[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*\]/;
  var STACK_TRACE_PATTERN =
    /(?:at[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]+(?:[\0-\x08\x0E-\x1F!-\x9F\xA1-\u167F\u1681-\u1FFF\u200B-\u2027\u202A-\u202E\u2030-\u205E\u2060-\u2FFF\u3001-\uD7FF\uE000-\uFEFE\uFF00-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])+|JavaException:|Error:[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF])/;
  ...
  function runStreamCleanupSuccessDeviceCheck(_0) {
    return __async(this, arguments, function (_ref30) {
      var testCaseId = _ref30.testCaseId,
        sourceUri = _ref30.sourceUri,
        expectedMimeType = _ref30.expectedMimeType,
        expectedSizeBytes = _ref30.expectedSizeBytes,
        maxSizeBytes = _ref30.maxSizeBytes,
        readerSafetyLimitBytes = _ref30.readerSafetyLimitBytes,
        context = _ref30.context,
        contentResolver = _ref30.contentResolver,
        parseUri = _ref30.parseUri,
        javaBridge = _ref30.javaBridge,
        _ref30$isFileUriAppro = _ref30.isFileUriApproved,
        isFileUriApproved =
          _ref30$isFileUriAppro === void 0
            ? function () {
                return false;
              }
            : _ref30$isFileUriAppro,
        openFileReadOnly = _ref30.openFileReadOnly,
        _ref30$reportMetadata = _ref30.reportMetadata,
        reportMetadata =
          _ref30$reportMetadata === void 0
            ? function () {}
            : _ref30$reportMetadata;
            ...
            while (1)
              switch ((_context22.p = _context22.n)) {
                case 0:
                  ...
                  closeCount = 0;
                  instrumentedResolver = createInstrumentedResolver2(
                    contentResolver,
                    function () {
                      closeCount += 1;
                    },
  ...
  function normalizeReaderResult2(_ref31) {
    var testCaseId = _ref31.testCaseId,
      expectedMimeType = _ref31.expectedMimeType,
      expectedSizeBytes = _ref31.expectedSizeBytes,
      maxSizeBytes = _ref31.maxSizeBytes,
      result = _ref31.result,
      closeCount = _ref31.closeCount;
    var bytes = safelyReadProperty8(result, "bytes");
    var reportedMimeType = safelyReadProperty8(result, "mimeType");
    if (!(bytes instanceof Uint8Array)) {
  ...
  function normalizeErrorCode3(error) {
    var code = safelyReadProperty8(error, "code");
    if (PUBLIC_ERROR_CODES11.has(code)) {
      return code;
    }
    var classification = safelyReadProperty8(error, "classification");
    if (
      classification === IMAGE_READER_ERROR_CLASSIFICATIONS.URI_ACCESS_DENIED
    ) {
      return IMAGE_INPUT_ERROR_CODES.URI_ACCESS_DENIED;
  ...
  function failureWithCloseCount(testCaseId, errorCode, closeCount) {
    return Object.freeze({
      testCaseId: testCaseId,
      status: "FAIL",
      errorCode: PUBLIC_ERROR_CODES11.has(errorCode)
        ? errorCode
        : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED,
      closeCount: closeCount,
    });
  ...
  function validateInputs6(_ref32) {
    var testCaseId = _ref32.testCaseId,
      ...
      reportMetadata = _ref32.reportMetadata;
    if (typeof testCaseId !== "string" || !SAFE_CASE_ID6.test(testCaseId)) {
      throw new TypeError("testCaseId must be an opaque uppercase case ID");
    }
    if (
      typeof expectedMimeType !== "string" ||
      !SAFE_MIME_TYPE4.test(expectedMimeType) ||
      normalizeMimeType(expectedMimeType) !== expectedMimeType
    ) {
      throw new TypeError("expectedMimeType must be a normalized image MIME");
    }
  ...
  function runUiResponsivenessDeviceCheck(_a) {
    return __async(
      this,
      null,
      _regenerator().m(function _callee23() {
        var _b,
          expectedSizeBytes,
          _b$reportMetadata7,
          reportMetadata,
          ...
          while (1)
            switch (_context23.n) {
              case 0:
                ((_b = _a),
                  (expectedSizeBytes = _b.expectedSizeBytes),
                  (_b$reportMetadata7 = _b.reportMetadata),
                  (reportMetadata =
                    _b$reportMetadata7 === void 0
                      ? function () {}
                      : _b$reportMetadata7),
                  (_b$uiHeartbeat = _b.uiHeartbeat),
                  (uiHeartbeat =
                    _b$uiHeartbeat === void 0
                      ? function () {
              ...
              case 5:
                matchesRequiredMetadata =
                  result.status === "PASS" &&
                  result.mimeType === REQUIRED_MIME_TYPE3 &&
                  result.sizeBytes === expectedSizeBytes;
                matchesFirstIteration =
                  iteration === 1 ||
                  (result.mimeType === firstMimeType &&
              ...
              case 8:
                allMetadataEqual =
                  successfulIterations === REQUESTED_ITERATIONS3 &&
                  publicErrorCode === void 0 &&
                  metadataMismatch === false;
  ...
  function createLoopRecord3(_ref33) {
    var testCaseId = _ref33.testCaseId,
      attemptedIterations = _ref33.attemptedIterations,
      successfulIterations = _ref33.successfulIterations,
      allMetadataEqual = _ref33.allMetadataEqual,
      publicErrorCode = _ref33.publicErrorCode,
      metadataMismatch = _ref33.metadataMismatch,
      mimeType = _ref33.mimeType,
      sizeBytes = _ref33.sizeBytes,
      heartbeatCount = _ref33.heartbeatCount,
      uiBlocked = _ref33.uiBlocked;
    var common = {
      testCaseId: testCaseId,
  ...
  function normalizePublicErrorCode4(errorCode) {
    return PUBLIC_ERROR_CODES12.has(errorCode)
      ? errorCode
      : IMAGE_INPUT_ERROR_CODES.IMAGE_READ_FAILED;
  }
  function validateInputs7(_ref34) {
    var expectedSizeBytes = _ref34.expectedSizeBytes,
      reportMetadata = _ref34.reportMetadata,
      uiHeartbeat = _ref34.uiHeartbeat;
    if (!Number.isSafeInteger(expectedSizeBytes) || expectedSizeBytes <= 0) {
      throw new TypeError("expectedSizeBytes must be a positive safe integer");
    }
    if (typeof reportMetadata !== "function") {
  ...
  function runAutoJs6FormatCheck(formatCase, injectedRuntime) {
    ...
    return runFormatCheck(formatCase, {
      showInstructions: function showInstructions(_ref35) {
        var title = _ref35.title,
          instructionText = _ref35.instructionText;
        return runtime.dialogs.alert(title, instructionText);
      },
      pickSingleImage: function pickSingleImage(_ref36) {
        var pickerMimeType = _ref36.pickerMimeType,
          requestCode = _ref36.requestCode;
          ...
          while (1)
            switch (_context24.n) {
              ...
              case 3:
                ...
                return _context24.a(
                  2,
                  runMultiImageSequentialDeviceCheck({
                    sourceUris: sourceUris,
                    expectedImages: expectedImages,
                    testCaseId: formatCase.testCaseId,
  ...
  function pickMultipleImages(runtime, pickerMimeType, requestCode) {
    return new Promise(function (resolve) {
      ...
      try {
        var intent = new runtime.android.content.Intent(
  ...
  function _pickSingleImage(runtime, pickerMimeType, requestCode) {
    return new Promise(function (resolve) {
      var settled = false;
      var _listener2 = function listener(
        receivedRequestCode,
        resultCode,
        data,
      ) {
  ...
  function _executeOffUiThread(runtime, task) {
    return new Promise(function (resolve) {
      var completed = new runtime.java.util.concurrent.atomic.AtomicBoolean(
        false,
      );
      var heartbeat = new runtime.java.util.concurrent.atomic.AtomicBoolean(
        false,
      );
      var worker = null;
    ...
    if (formatCase.verificationMode === "ui-responsiveness") {
      return runUiResponsivenessDeviceCheck({
        ...
        uiHeartbeat: function uiHeartbeat() {
          return new Promise(function (resolve) {
            try {
              var handler = new runtime.android.os.Handler(
    ...
    if (formatCase.verificationMode === "no-persistence") {
      return runNoPersistenceDeviceCheck({
        ...
        prepareSelectedImage: function prepareSelectedImage(invalidUri) {
          return _prepareSelectedImage(
            runtime,
            invalidUri != null ? invalidUri : sourceUri,
            testCaseId,
            formatCase,
          );
        },
  ...
  function _classifyError(runtime, error) {
    ...
    try {
      var candidate =
        (_a = error == null ? void 0 : error.javaException) != null
          ? _a
          : error;
